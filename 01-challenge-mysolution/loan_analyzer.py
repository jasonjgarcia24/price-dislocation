...
print(f'The total number of loans is: {number_of_loans:.0f}')
...
print(f'The remaining months is: {remaining_months:.0f}')
...
# YOUR CODE HERE!
present_value = calc_present_value(new_loan['future_value'],
